...
## load data
rodent <- read_csv('Dipo_counts.csv')
...
gam.check(m1, rep = 500) # not too bad, resids are iffy, but low means
...
summary(m2)       # most plot-specific differences are shrunk to 0 EDF, except 14, 17, 13
