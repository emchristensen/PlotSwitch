...
## load data
rodent <- read_csv('SpeciesRichness.csv')
...
gam.check(m1, rep = 500) # there's something off about the q-q plot
summary(m1)           
...
AIC(m1, m2)                             # favours no plot-specific smooths
